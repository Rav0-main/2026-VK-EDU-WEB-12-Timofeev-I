...
urlpatterns = [
    ...
    path(
        ...
        views.QuestionLikeAddView.as_view(),
        name="question_like_add",
    ),
    path(
        "questions/<int:question_id>/answers",
        views.AnswerAddView.as_view(),
        name="answer_add",
    ),
    path(
        "answers/<int:answer_id>/like",
        views.AnswerLikeAddView.as_view(),
        name="answer_like_add",
    ),
    path(
        "answers/<int:answer_id>/set-correct",
        views.AnswerSetCorrectView.as_view(),
        name="answer_set_correct",
    ),
