...
class Answer(models.Model):
    ...
    is_correct = models.BooleanField(
        verbose_name=_("Это правильный ответ?"), default=False
    )
    ...
    class Meta:
        unique_together = ["question", "author", "content"]
    ...
    def __str__(self) -> str:
        return _(
            f"Ответ на: {self.question.title}, правильность: {self.is_correct}, автор: {self.author}"
        )
